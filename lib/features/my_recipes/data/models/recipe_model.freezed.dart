...
@HiveField(18) int? get servings;@HiveField(19) NutritionModel? get nutrition;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,title,prepTimeMinutes,cookTimeMinutes,const DeepCollectionEquality().hash(ingredients),const DeepCollectionEquality().hash(steps),const DeepCollectionEquality().hash(dietaryTags),sourceChannel,sourceUrl,createdAt,imageFileName,savedFromSharedId,pendingAnalysis,collabId,collabRole,imageStoragePath,const DeepCollectionEquality().hash(allergens),const DeepCollectionEquality().hash(mayContain),servings,nutrition]);

@override
String toString() {
  return 'RecipeModel(id: $id, title: $title, prepTimeMinutes: $prepTimeMinutes, cookTimeMinutes: $cookTimeMinutes, ingredients: $ingredients, steps: $steps, dietaryTags: $dietaryTags, sourceChannel: $sourceChannel, sourceUrl: $sourceUrl, createdAt: $createdAt, imageFileName: $imageFileName, savedFromSharedId: $savedFromSharedId, pendingAnalysis: $pendingAnalysis, collabId: $collabId, collabRole: $collabRole, imageStoragePath: $imageStoragePath, allergens: $allergens, mayContain: $mayContain, servings: $servings, nutrition: $nutrition)';
}
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@HiveField(0)  String id, @HiveField(1)  String title, @HiveField(2)  int? prepTimeMinutes, @HiveField(3)  int? cookTimeMinutes, @HiveField(4)  List<RecipeIngredientModel> ingredients, @HiveField(5)  List<String> steps, @HiveField(6)  List<DietaryPreference> dietaryTags, @HiveField(7)  String? sourceChannel, @HiveField(8)  String? sourceUrl, @HiveField(9)  DateTime createdAt, @HiveField(10)  String? imageFileName, @HiveField(11)  String? savedFromSharedId, @HiveField(12)  bool pendingAnalysis, @HiveField(13)  String? collabId, @HiveField(14)  String? collabRole, @HiveField(15)  String? imageStoragePath, @HiveField(16)  List<String> allergens, @HiveField(17)  List<String> mayContain, @HiveField(18)  int? servings, @HiveField(19)  NutritionModel? nutrition)  $default,) {final _that = this;
switch (_that) {
case _RecipeModel():
return $default(_that.id,_that.title,_that.prepTimeMinutes,_that.cookTimeMinutes,_that.ingredients,_that.steps,_that.dietaryTags,_that.sourceChannel,_that.sourceUrl,_that.createdAt,_that.imageFileName,_that.savedFromSharedId,_that.pendingAnalysis,_that.collabId,_that.collabRole,_that.imageStoragePath,_that.allergens,_that.mayContain,_that.servings,_that.nutrition);}
}
