...
@HiveField(14) String? get collabRole;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,prepTimeMinutes,cookTimeMinutes,const DeepCollectionEquality().hash(ingredients),const DeepCollectionEquality().hash(steps),const DeepCollectionEquality().hash(dietaryTags),sourceChannel,sourceUrl,createdAt,imageFileName,savedFromSharedId,pendingAnalysis,collabId,collabRole);

@override
String toString() {
  return 'RecipeModel(id: $id, title: $title, prepTimeMinutes: $prepTimeMinutes, cookTimeMinutes: $cookTimeMinutes, ingredients: $ingredients, steps: $steps, dietaryTags: $dietaryTags, sourceChannel: $sourceChannel, sourceUrl: $sourceUrl, createdAt: $createdAt, imageFileName: $imageFileName, savedFromSharedId: $savedFromSharedId, pendingAnalysis: $pendingAnalysis, collabId: $collabId, collabRole: $collabRole)';
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@HiveField(0)  String id, @HiveField(1)  String title, @HiveField(2)  int? prepTimeMinutes, @HiveField(3)  int? cookTimeMinutes, @HiveField(4)  List<RecipeIngredientModel> ingredients, @HiveField(5)  List<String> steps, @HiveField(6)  List<DietaryPreference> dietaryTags, @HiveField(7)  String? sourceChannel, @HiveField(8)  String? sourceUrl, @HiveField(9)  DateTime createdAt, @HiveField(10)  String? imageFileName, @HiveField(11)  String? savedFromSharedId, @HiveField(12)  bool pendingAnalysis, @HiveField(13)  String? collabId, @HiveField(14)  String? collabRole)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RecipeModel() when $default != null:
return $default(_that.id,_that.title,_that.prepTimeMinutes,_that.cookTimeMinutes,_that.ingredients,_that.steps,_that.dietaryTags,_that.sourceChannel,_that.sourceUrl,_that.createdAt,_that.imageFileName,_that.savedFromSharedId,_that.pendingAnalysis,_that.collabId,_that.collabRole);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@HiveField(0)  String id, @HiveField(1)  String title, @HiveField(2)  int? prepTimeMinutes, @HiveField(3)  int? cookTimeMinutes, @HiveField(4)  List<RecipeIngredientModel> ingredients, @HiveField(5)  List<String> steps, @HiveField(6)  List<DietaryPreference> dietaryTags, @HiveField(7)  String? sourceChannel, @HiveField(8)  String? sourceUrl, @HiveField(9)  DateTime createdAt, @HiveField(10)  String? imageFileName, @HiveField(11)  String? savedFromSharedId, @HiveField(12)  bool pendingAnalysis, @HiveField(13)  String? collabId, @HiveField(14)  String? collabRole)  $default,) {final _that = this;
switch (_that) {
case _RecipeModel():
return $default(_that.id,_that.title,_that.prepTimeMinutes,_that.cookTimeMinutes,_that.ingredients,_that.steps,_that.dietaryTags,_that.sourceChannel,_that.sourceUrl,_that.createdAt,_that.imageFileName,_that.savedFromSharedId,_that.pendingAnalysis,_that.collabId,_that.collabRole);}
}
...
class _RecipeModel implements RecipeModel {
  const _RecipeModel({@HiveField(0) required this.id, @HiveField(1) required this.title, @HiveField(2) this.prepTimeMinutes, @HiveField(3) this.cookTimeMinutes, @HiveField(4) required final  List<RecipeIngredientModel> ingredients, @HiveField(5) required final  List<String> steps, @HiveField(6) final  List<DietaryPreference> dietaryTags = const [], @HiveField(7) this.sourceChannel, @HiveField(8) this.sourceUrl, @HiveField(9) required this.createdAt, @HiveField(10) this.imageFileName, @HiveField(11) this.savedFromSharedId, @HiveField(12) this.pendingAnalysis = false, @HiveField(13) this.collabId, @HiveField(14) this.collabRole}): _ingredients = ingredients,_steps = steps,_dietaryTags = dietaryTags;
