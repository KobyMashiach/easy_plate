...
@HiveField(15) String? get imageStoragePath;// Allergen names as strings, like `collabRole`. Recipes stored before
// these existed decode as null, which the adapter reads as empty.
@HiveField(16) List<String> get allergens;@HiveField(17) List<String> get mayContain;// Servings and per-serving nutrition, appended like everything above:
// older recipes decode as null and show as "not estimated yet".
@HiveField(18) int? get servings;@HiveField(19) NutritionModel? get nutrition;// The community post id, appended: older recipes decode as null.
@HiveField(20) String? get sharedRecipeId;
...
@useResult
$Res call({
@HiveField(0) String id,@HiveField(1) String title,@HiveField(2) int? prepTimeMinutes,@HiveField(3) int? cookTimeMinutes,@HiveField(4) List<RecipeIngredientModel> ingredients,@HiveField(5) List<String> steps,@HiveField(6) List<DietaryPreference> dietaryTags,@HiveField(7) String? sourceChannel,@HiveField(8) String? sourceUrl,@HiveField(9) DateTime createdAt,@HiveField(10) String? imageFileName,@HiveField(11) String? savedFromSharedId,@HiveField(12) bool pendingAnalysis,@HiveField(13) String? collabId,@HiveField(14) String? collabRole,@HiveField(15) String? imageStoragePath,@HiveField(16) List<String> allergens,@HiveField(17) List<String> mayContain,@HiveField(18) int? servings,@HiveField(19) NutritionModel? nutrition,@HiveField(20) String? sharedRecipeId
});
...
/// Create a copy of RecipeModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? prepTimeMinutes = freezed,Object? cookTimeMinutes = freezed,Object? ingredients = null,Object? steps = null,Object? dietaryTags = null,Object? sourceChannel = freezed,Object? sourceUrl = freezed,Object? createdAt = null,Object? imageFileName = freezed,Object? savedFromSharedId = freezed,Object? pendingAnalysis = null,Object? collabId = freezed,Object? collabRole = freezed,Object? imageStoragePath = freezed,Object? allergens = null,Object? mayContain = null,Object? servings = freezed,Object? nutrition = freezed,Object? sharedRecipeId = freezed,}) {
...
as List<String>,mayContain: null == mayContain ? _self.mayContain : mayContain // ignore: cast_nullable_to_non_nullable
...
as NutritionModel?,sharedRecipeId: freezed == sharedRecipeId ? _self.sharedRecipeId : sharedRecipeId // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
/// Create a copy of RecipeModel
...
$NutritionModelCopyWith<$Res>? get nutrition {
  ...
  return $NutritionModelCopyWith<$Res>(_self.nutrition!, (value) {
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@HiveField(0)  String id, @HiveField(1)  String title, @HiveField(2)  int? prepTimeMinutes, @HiveField(3)  int? cookTimeMinutes, @HiveField(4)  List<RecipeIngredientModel> ingredients, @HiveField(5)  List<String> steps, @HiveField(6)  List<DietaryPreference> dietaryTags, @HiveField(7)  String? sourceChannel, @HiveField(8)  String? sourceUrl, @HiveField(9)  DateTime createdAt, @HiveField(10)  String? imageFileName, @HiveField(11)  String? savedFromSharedId, @HiveField(12)  bool pendingAnalysis, @HiveField(13)  String? collabId, @HiveField(14)  String? collabRole, @HiveField(15)  String? imageStoragePath, @HiveField(16)  List<String> allergens, @HiveField(17)  List<String> mayContain, @HiveField(18)  int? servings, @HiveField(19)  NutritionModel? nutrition, @HiveField(20)  String? sharedRecipeId)  $default,) {final _that = this;
switch (_that) {
case _RecipeModel():
return $default(_that.id,_that.title,_that.prepTimeMinutes,_that.cookTimeMinutes,_that.ingredients,_that.steps,_that.dietaryTags,_that.sourceChannel,_that.sourceUrl,_that.createdAt,_that.imageFileName,_that.savedFromSharedId,_that.pendingAnalysis,_that.collabId,_that.collabRole,_that.imageStoragePath,_that.allergens,_that.mayContain,_that.servings,_that.nutrition,_that.sharedRecipeId);}
}
...
// Allergen names as strings, like `collabRole`. Recipes stored before
// these existed decode as null, which the adapter reads as empty.
@override@JsonKey()@HiveField(16) List<String> get allergens {
  if (_allergens is EqualUnmodifiableListView) return _allergens;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_allergens);
}

 final  List<String> _mayContain;
@override@JsonKey()@HiveField(17) List<String> get mayContain {
  if (_mayContain is EqualUnmodifiableListView) return _mayContain;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_mayContain);
}

// Servings and per-serving nutrition, appended like everything above:
// older recipes decode as null and show as "not estimated yet".
@override@HiveField(18) final  int? servings;
@override@HiveField(19) final  NutritionModel? nutrition;
// The community post id, appended: older recipes decode as null.
@override@HiveField(20) final  String? sharedRecipeId;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _RecipeModel&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&(identical(other.prepTimeMinutes, prepTimeMinutes) || other.prepTimeMinutes == prepTimeMinutes)&&(identical(other.cookTimeMinutes, cookTimeMinutes) || other.cookTimeMinutes == cookTimeMinutes)&&const DeepCollectionEquality().equals(other._ingredients, _ingredients)&&const DeepCollectionEquality().equals(other._steps, _steps)&&const DeepCollectionEquality().equals(other._dietaryTags, _dietaryTags)&&(identical(other.sourceChannel, sourceChannel) || other.sourceChannel == sourceChannel)&&(identical(other.sourceUrl, sourceUrl) || other.sourceUrl == sourceUrl)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.imageFileName, imageFileName) || other.imageFileName == imageFileName)&&(identical(other.savedFromSharedId, savedFromSharedId) || other.savedFromSharedId == savedFromSharedId)&&(identical(other.pendingAnalysis, pendingAnalysis) || other.pendingAnalysis == pendingAnalysis)&&(identical(other.collabId, collabId) || other.collabId == collabId)&&(identical(other.collabRole, collabRole) || other.collabRole == collabRole)&&(identical(other.imageStoragePath, imageStoragePath) || other.imageStoragePath == imageStoragePath)&&const DeepCollectionEquality().equals(other._allergens, _allergens)&&const DeepCollectionEquality().equals(other._mayContain, _mayContain)&&(identical(other.servings, servings) || other.servings == servings)&&(identical(other.nutrition, nutrition) || other.nutrition == nutrition)&&(identical(other.sharedRecipeId, sharedRecipeId) || other.sharedRecipeId == sharedRecipeId));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,title,prepTimeMinutes,cookTimeMinutes,const DeepCollectionEquality().hash(_ingredients),const DeepCollectionEquality().hash(_steps),const DeepCollectionEquality().hash(_dietaryTags),sourceChannel,sourceUrl,createdAt,imageFileName,savedFromSharedId,pendingAnalysis,collabId,collabRole,imageStoragePath,const DeepCollectionEquality().hash(_allergens),const DeepCollectionEquality().hash(_mayContain),servings,nutrition,sharedRecipeId]);
...
@override $NutritionModelCopyWith<$Res>? get nutrition;
...
as List<String>,mayContain: null == mayContain ? _self._mayContain : mayContain // ignore: cast_nullable_to_non_nullable
as List<String>,servings: freezed == servings ? _self.servings : servings // ignore: cast_nullable_to_non_nullable
as int?,nutrition: freezed == nutrition ? _self.nutrition : nutrition // ignore: cast_nullable_to_non_nullable
as NutritionModel?,sharedRecipeId: freezed == sharedRecipeId ? _self.sharedRecipeId : sharedRecipeId // ignore: cast_nullable_to_non_nullable
as String?,
