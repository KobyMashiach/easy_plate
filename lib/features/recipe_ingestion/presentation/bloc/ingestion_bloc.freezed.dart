...
class _GenerateRecipe with DiagnosticableTreeMixin implements IngestionEvent {
  const _GenerateRecipe(this.request);
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$GenerateRecipeCopyWith<_GenerateRecipe> get copyWith => __$GenerateRecipeCopyWithImpl<_GenerateRecipe>(this, _$identity);


@override
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ..add(DiagnosticsProperty('type', 'IngestionEvent.generateRecipe'))
    ..add(DiagnosticsProperty('request', request));
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _GenerateRecipe&&(identical(other.request, request) || other.request == request));
}
...
@override
String toString({ DiagnosticLevel minLevel = DiagnosticLevel.info }) {
  return 'IngestionEvent.generateRecipe(request: $request)';
}
...
/// @nodoc
abstract mixin class _$GenerateRecipeCopyWith<$Res> implements $IngestionEventCopyWith<$Res> {
  factory _$GenerateRecipeCopyWith(_GenerateRecipe value, $Res Function(_GenerateRecipe) _then) = __$GenerateRecipeCopyWithImpl;
@useResult
$Res call({
 String request
});
...
/// @nodoc
class __$GenerateRecipeCopyWithImpl<$Res>
    implements _$GenerateRecipeCopyWith<$Res> {
  __$GenerateRecipeCopyWithImpl(this._self, this._then);

  final _GenerateRecipe _self;
  final $Res Function(_GenerateRecipe) _then;

/// Create a copy of IngestionEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? request = null,}) {
  return _then(_GenerateRecipe(
