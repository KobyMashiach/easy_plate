...
extension MealItemModelMapper on MealItemModel {
  MealItemEntity toEntity() => MealItemEntity(id: id, recipeId: recipeId, freeText: freeText);
}

extension MealItemEntityMapper on MealItemEntity {
  MealItemModel toModel() => MealItemModel(id: id, recipeId: recipeId, freeText: freeText);
}
