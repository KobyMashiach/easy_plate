...
/// Type scale synchronised from the Stitch design system. Getters rather than
/// finals: the default colour follows the current theme, so a style cached
/// once would carry the wrong ink after a switch.
/// Sizes, weights,
